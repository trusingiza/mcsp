...
class FacilitiesControllerTest < ActionController::TestCase
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post :create, facility: { facility_name: @facility.facility_name, fosa_code: @facility.fosa_code, location_id: @facility.location_id }
    end
  ...
  test "should update facility" do
    patch :update, id: @facility, facility: { facility_name: @facility.facility_name, fosa_code: @facility.fosa_code, location_id: @facility.location_id }
    assert_redirected_to facility_path(assigns(:facility))
  end
